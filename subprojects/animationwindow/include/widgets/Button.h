...
namespace TDT4102 {
    ...
    public:
        ...
        void setButtonColor(Color newColor) {buttonColor = nk_color{(nk_byte)newColor.redChannel, (nk_byte)newColor.greenChannel, (nk_byte)newColor.blueChannel, 100};} //(nk_byte)newColor.alphaChannel}
